  ...
  render() {
    ...
    return (
      <div className='p-4 w-full relative'>
        ...
        <div className='h-full bg-gray-900 border-0 border-gray-800 p-8 rounded-md flex flex-col'>
          <p className='flex flex-grow leading-relaxed mb-6 text-sm font-body md:text-base'>
